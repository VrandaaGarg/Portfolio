...
function Footer() {
  ...
  const socials = [
    ...
    { icon: FaLinkedin, url: "https://www.linkedin.com/in/vranda-garg-b68011293/", color: "#0A66C2" },
    { icon: FaInstagram, url: "https://www.instagram.com/vranda_garg", color: "#E4405F" },
    { icon: CiMail, url: "mailto:vrandacodz@gmail.com", color: "#EA4335" }
  ];
